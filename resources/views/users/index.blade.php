...
<div class="page-inner">
    <div class="page-title">
        ...
        <a class="addTable btn btn-default" href="{{ route('userFormAdd') }}" title="Add">Add</a>
    </div>
                ...
                <table class="tableListing table table-hover table-bordered display">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('userFormEdit', ['id' => $row->id]) }}" title="Edit">
                                    <i class="fa fa-pencil-square-o buttonEditListing"></i>
                                </a>
                                <a href="javascript:void(0)" onClick="deleteData({{$row->id}}, 'userDelete');" title="Delete">
